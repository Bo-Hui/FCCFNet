...
def parse_args():
    ...
    parser.add_argument('--dataset', type=str, default='sirst', help='datasets: sirst or IRSTD-1k,NUDT')
    parser.add_argument('--mode', type=str, default='L', help='mode: L, M, S')
    parser.add_argument('--checkpoint', type=str, default=r'weights\sirst_best_iou.pth', help='checkpoint: .pth')
...
class Val:
    ...
    def test_model(self):
        ...
        for i, (data, labels) in enumerate(tbar):
            ...
            data = np.transpose(np.squeeze(data), (1, 2, 0))
